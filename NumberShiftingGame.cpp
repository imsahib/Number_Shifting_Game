...
{
    private:
        int arr[4][4], tries,matrix_size;              // ARRAY OF 4x4 SIZE, NUMBER OF TRIES, MATRIX SIZE
...
{
    system("cls");
    cout<<endl<<CIAN <<"\t\t N U M B E R   S H I F T I N G   G A M E !  "<<RESET <<endl<<endl<<endl;
...
int main()
{
    ...
    system("Color 0A");             
    cout<<endl<<endl<<endl<<"\t\t W E L C O M E    T O    "<<RESET<<CIAN<<"N U M B E R   S H I F T I N G    G A M E ! :  "<<RESET;
